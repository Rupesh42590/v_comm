  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData.dark().copyWith(
        ...
        // 🔹 Global Button Theme with improved visibility
        ...
        // Custom time picker theme to remove purple colors
        timePickerTheme: TimePickerThemeData(
          ...
          helpTextStyle: TextStyle(color: Colors.white.withOpacity(0.8)),
